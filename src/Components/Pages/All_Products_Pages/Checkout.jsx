...
const Checkout = () => {
    return (
        <Box >
            ...
            <Box alignItems={'center'} w='70%' m='auto' mt={3}>
          <Link to='/'> <Image w='20%' src='https://seeklogo.com/images/S/skinstore-logo-5281C41BD3-seeklogo.com.png' alt='logocheckout' /></Link>     
            </Box>
            <hr />
            <Box >
                <Flex>
                    <Box  w={"55%"} >
                      ...
                      <Button mt={'10'} bgColor='black'w="65%" color={'white'}>Submit-My-Order </Button>
                    </Box>
...
{/* ***********total item box*********** */}
                 ...
                 <Center>
                       <Flex justifyContent={'space-between'} w='70%'>
                        <Text fontSize={'18'} fontWeight='bold'>Order Summery</Text>
                        <Text fontSize={'18'} fontWeight='bold'>1 items</Text>
                    </Flex>
                 </Center>                   
<Center>  
...
<Center>
<Flex justifyContent={'space-between'} w='70%'>
<Text fontSize={'18'} fontWeight='bold' color={'green'}>Total To Pay</Text>
<Text fontSize={'18'} fontWeight='bold' color={'teal'}>$356.00</Text>
</Flex>

...
import { Box, Image ,Center,Text,Flex,Heading,Button,Card,CardBody,Stack,CardFooter,Divider} from '@chakra-ui/react';
...
const HairPage = () => {
  return (
    ...
    <Box w='90%' m='auto' border={'2px solid black'} mt='2' borderRadius={10} >    
      <Link to='/hair'>
       <Image  borderRadius={10} src='https://static.thcdn.com/images/xlarge/webp/widgets/121-us/23/SS-Batching-Christmas-Category_Banner-EG1180x450_4-082423.jpg' alt='hair image'/> 
      </Link>        
    </Box>
...
<Text fontSize={45}>Shop by Hair Focus</Text>
<Box mt={8} alignItems='center' w='85%' margin='auto'>
 ...
 <Link>
 <Link to='/hair'><Image w={205} src='https://static.thcdn.com/images/small/webp/widgets/121-us/14/Page-001-015714.png' alt="cat-1"/></Link> 
 </Link>
 <Link>
 <Link to='/hair'><Image w={205} src="https://static.thcdn.com/images/small/webp/widgets/121-us/23/Page-002-015723.png" alt="cat-2"/></Link> 
 </Link> 
  <Link>
   <Link to='/hair'><Image w={205} src="https://static.thcdn.com/images/small/webp/widgets/121-us/32/Page-003-015732.png" alt="cat-3"/></Link> 
  </Link>
 <Link>
 <Link to='/hair'><Image w={205} src="https://static.thcdn.com/images/small/webp/widgets/121-us/42/Page-004-015742.png" alt="cat-4"/></Link> 
 </Link>
  <Link>
   <Link to='/hair'><Image w={205} src="https://static.thcdn.com/images/small/webp/widgets/121-us/50/Page-005-015750.png" alt="cat-5"/></Link> 
  </Link>
 <Link>
 <Link to='/hair'><Image w={205} src="https://static.thcdn.com/images/small/webp/widgets/121-us/56/Page-006-015756.png" alt="cat-6"/></Link> 
 </Link>
  </Box>
...
<CardFooter>
 ...
 <Center>
  <Flex direction={['column','column','row']}   w={"95%"} gap={4} m='auto' justifyContent={'space-between'}>
        ...
        <Box w={['100%','100%','30%']}>
          <Center>
            <Image borderRadius={200} src="https://static.thcdn.com/images/small/webp/widgets/121-us/35/0115-TUU087-SS-AH-February-Batching-Shot-24-1080x1080-072235.jpg"  w={'100%'}alt="1"/> 
          </Center>
         <Heading fontSize={20} mt={4}>hair Gift</Heading>
      ...
      <Box w={['100%','100%','30%']}>
        <Center>
         <Image borderRadius={200} src="https://static.thcdn.com/images/small/webp/widgets/121-us/16/original-hair_color-084316.jpg"  w={'100%'}alt={"2"}/>  
        </Center>
          <Heading fontSize={20} mt={4}>20%off hair+$135 gift</Heading>
          <Text fontSize={13} mt={2} color="gray">hair (Worth $135) when you spend $250 or more on the brand.</Text>
      <Button bgColor={"white"} border='1px solid gray' borderRadius={'0'} mt={5}>SHOP-NOW</Button>
      </Box>
      <Box w={['100%','100%','30%']}>
        <Center>
          <Image  borderRadius={200} src="https://static.thcdn.com/images/small/webp/widgets/121-us/33/0201-TUU087-SS-AH-February-Batching-Shot-25-1080x1080-072333.jpg" w={'100%'}alt={"3"}/>
        </Center>
         <Heading fontSize={20} mt={4}>25%off hair with code REPLAY+$95 Gift</Heading>
